...
def create_image(songs, artists, username):
    ...
    d = ImageDraw.Draw(bg)
    d.text((33,26), username+ "Download your stats from https://statify-tool.herokuapp.com", font=font, fill=(255,255,255))
...
def serve_image(img):
    ...
    img.save(img_io, 'PNG')
    img_io.seek(0)
    return send_file(img_io, mimetype='image/png', as_attachment=True, attachment_filename='Statify.png')
